function fun_write_Dicom_SWIave_Heather(Data_dir,matrix_size,SWI_img_ave)
...
mkdir('SWI_IMG_Ave_Results'); %% Heather, added
saveDir_Final=strcat(saveDir,'\SWI_IMG_Ave_Results');%% Heather, added
