function fun_write_Dicom_MagAve_Heather(Data_dir,matrix_size,mag_img_ave)
...
mkdir('Mag_IMG_Ave_Results'); %% Heather, added
saveDir_Final=strcat(saveDir,'\Mag_IMG_Ave_Results');%% Heather, added
