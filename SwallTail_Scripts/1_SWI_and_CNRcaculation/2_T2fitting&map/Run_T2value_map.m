...
pathname_T1='E:\Subjects_T2\Sub_202\Scan1\SWI';
pathname_SWI0='E:\Subjects_T2\Sub_202\Scan1\SWI00';
...
%      end
     ...
     [T2map]=fun_T2map(pathname_SWI0,mfile_dir,echoNum,xdata,g0);
     figure;imagesc(T2map(:,:,30));axis image;colormap(gray);title('T2map of')
%      pathname_T1=strcat(pathname_SWI0,'\T1_mask');
     cd(pathname_SWI0)
     save T2map T2map
     %%% end, T2map
