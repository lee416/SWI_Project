...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% start, draw ROI %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%% start, preview of the images with nigrosome-1
Title='Please input ROI slice numbers';
Prompt={'ROI slice number 1','ROI slice number 2','ROI slice number 3','Partition number'};
LineNo=1;
DefAns={'31','32','33','2'};
answer=inputdlg(Prompt,Title,LineNo,DefAns);
ROI_slice=str2num(answer{2});
partition_number=str2num(answer{4});

for sss=(ROI_slice-1):(ROI_slice+1)
 figure;imagesc(img_all(:,:,sss));colormap(gray(256));axis('image');axis off;title(strcat('slice',num2str(sss)));
end
...
SWI_ROI_All_All=SWI_ROI_All_L+SWI_ROI_All_R;
