function [CNR_matrix0]=fun_CNR_calculation(Big_matrix,mask,masknigrosomeL,masknigrosomeR,masksubstantianigraL,masksubstantianigraR,num_of_MRI,num_of_CNR,total_of_CNR);
