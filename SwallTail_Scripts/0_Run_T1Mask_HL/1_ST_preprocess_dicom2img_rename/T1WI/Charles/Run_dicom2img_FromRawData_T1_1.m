...
Subjects=[210:222];
echo=7; % varify from subject 201~203 >>7,204~209 >>8,210~222 >>7,
Scan_num=[1];

 pathname_1='F:\SwallowTail_Project\Subject_Normal_Raw';
 pathname_D0='F:\SwallowTail_Project\Subjects';
...
%%%%%%%% skip for 222, 223 since folders differ
 brain=ls;
 brainread=brain(3,:);
...
%%%%%%%% T1 data %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
 cd(pathname2name)
 T1dir=ls('T1_MPRAGE_*');
 pathnameT1=strcat(pathname2name,'\',T1dir); % be changed
 cd(pathnameT1)
