...
%for ss=3:3
   ...
   if System_Flag==0       
     if Subjects(ss)<10
     pathname_0=strcat(pathname_0_1,'/','nick','00',int2str(Subjects(ss)),'/pcasl_rest');
     pathname_1=strcat(pathname_1_1,'/','s','00',int2str(Subjects(ss)),'/pcasl_rest/');
     elseif Subjects(ss)<=99&Subjects(ss)>=10
     pathname_0=strcat(pathname_0_1,'/','nick','0',int2str(Subjects(ss)),'/pcasl_rest');
     pathname_1=strcat(pathname_1_1,'/','s','0',int2str(Subjects(ss)),'/pcasl_rest/');
     else 
     pathname_0=strcat(pathname_0_1,'/','nick',int2str(Subjects(ss)),'/pcasl_rest');
     pathname_1=strcat(pathname_1_1,'/','s',int2str(Subjects(ss)),'/pcasl_rest/');
     end
   else         
     if Subjects(ss)<10
     pathname_0=strcat(pathname_0_1,'\','nick','00',int2str(Subjects(ss)),'\pcasl_rest');
