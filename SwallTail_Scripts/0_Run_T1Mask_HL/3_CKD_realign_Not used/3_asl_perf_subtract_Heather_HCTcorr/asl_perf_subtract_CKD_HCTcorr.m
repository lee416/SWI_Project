function [perfnum,glcbf] =asl_perf_subtract_CKD_HCTcorr(Filename, HCT_Sub)
...
for p=1:perfno
   ...
   fseq=fseq+1;
   prevpth=pth;
   %prefix  = [pth filesep 'Perf_' num2str(SubtractionType)]; %% Heather,comment out, HCTcorr
   %cbfprefix=[pth filesep 'cbf_' num2str(SubtractionType)]; %% Heather,comment out, HCTcorr
   
   prefix  = [pth filesep 'Perf_HCTcorr_' num2str(SubtractionType)]; %% Heather, added, HCTcorr
   cbfprefix=[pth filesep 'cbf_HCTcorr_' num2str(SubtractionType)]; %% Heather, added, HCTcorr
...
%   nm=strtok(midname,'_0123456789');
  nm=midname;
  %% Vmean.fname=[pth '/meanPERF_' num2str(SubtractionType) '_' nm imgaffix]; %% Heather, commnet out, HCTcorr
  Vmean.fname=[pth '/meanPERF_HCTcorr_' num2str(SubtractionType) '_' nm imgaffix]; %% Heather, added, HCTcorr
  if modernSPM
     Vmean.dt=[16 0]; 
  else %
  ...
  if CBFFlag==1
     %% Vmean.fname=[pth '/meanCBF_' num2str(SubtractionType) '_' nm imgaffix]; %% Heather, comment out, HCTcorr
     Vmean.fname=[pth '/meanCBF_HCTcorr_' num2str(SubtractionType) '_' nm imgaffix]; %% Heather, added, HCTcorr
...
% gsfile=[pth '/globalsg_' num2str(SubtractionType) '.txt']; %% Heather, comment out, HCTcorr
gsfile=[pth '/globalsg_HCTcorr_' num2str(SubtractionType) '.txt']; %% Heather, added, HCTcorr
